...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return {
        a: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            b: "7e8ead35-3-" + i0 + "-" + i1 + "," + ("7e8ead35-2-" + i0 + "-" + i1),
            c: common_vendor.p({
            ...
            f: "7e8ead35-2-" + i0 + "-" + i1 + "," + ("7e8ead35-1-" + i0)
          };
        }),
        b: "7e8ead35-1-" + i0 + ",7e8ead35-0",
        c: "7e8ead35-4-" + i0 + ",7e8ead35-0",
        d: common_vendor.p({
          state: {
            data,
            pagination,
    ...
    d: common_vendor.sr("udb", "7e8ead35-0"),
