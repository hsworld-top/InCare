...
function initRuntimeSocketService() {
  const hosts = "172.21.240.1,192.168.33.1,192.168.91.1,192.168.0.144,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_d_Fkva";
...
const b = true, E = "mp-weixin", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","172.21.240.1","192.168.33.1","192.168.91.1","192.168.0.144"],"servePort":7001,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","D:/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"in-care","spaceId":"mp-1a849f3c-3fbe-4b01-9ffe-85a1d8118c71","clientSecret":"lzzFCkvOipcMCWi96gVbBg==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__910D59E";
} catch (e2) {
